...
(34, '短网址列表', 'Domain', '/shortDomain', 1, 31, 1, 0, '2021-02-20 11:52:18', '2021-02-20 12:12:57', 1, ''),
...
(1, '网站名称', 'web_name', '基于OreoFrame框架的免费开源防洪短网址生成系统'),
(2, '网站域名', 'web_url', 'http://u.oreopay.com'),
(3, '工信部备案号', 'icp_num', '黔ICP备2020009901号'),
(4, '系统状态', 'system_state', '1'),
(5, '系统维护提示语', 'system_state_text', '基于OreoFrame框架的免费开源防洪短网址生成系统，作者QQ:609451870');
